    ...
    public partial class FrmEditHolyDay : RadForm
    {
        ...
        private void Savebtn_Click(object sender, EventArgs e)
        {
            ...
            Operation.BeginOperation(this);
             ...
             TargetHolyday.Employee.Status = statusComboBox.Text;
             var q = EmployeesCmd.GetByID(int.Parse(EmployeeComboBox.SelectedValue.ToString()));
             q.Status = statusComboBox.Text;
             EmployeesCmd.EditEmployee(q);
