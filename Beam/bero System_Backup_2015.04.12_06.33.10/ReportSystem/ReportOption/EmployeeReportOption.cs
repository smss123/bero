...
{
    public partial class EmployeeReportOption : RadForm
    {
        public EmployeeReportOption()
        {
            InitializeComponent();
        }
        Thread th;
        ...
        private void EmployeeReportOption_Load(object sender, EventArgs e)
        {
        ...
        private void SaveBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                EmployeeCommandRpt cmd = new EmployeeCommandRpt();
                cmd.GetAllEmployees();
            }
            else
            {
                EmployeeCommandRpt cmd = new EmployeeCommandRpt();
                cmd.GetEmployeeByID(int.Parse(EmployeeComboBox.SelectedValue.ToString()));
            }
